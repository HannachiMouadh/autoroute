...
import HomeCauseAdmin from "./Components/ParCause/HomeCauseAdmin";
import HomeCauseSuperAdmin from "./Components/ParCause/HomeCauseSuperAdmin";
import AllHome from "./Components/AllAccidentsSuperAdmin/AllHome";
...
function App({userManLieu, userDistrict,curuser,userRole,userAutonum,patUserAutonum,patUserDistrict}) {
  ...
  const currentRole = currentUserConnected?.role;
    ...
    <div className="App">
      <Routes>
        ...
        element={
          ...
          ) : currentRole === "entretient" ? (
            <Navigate to="/entretient" />
          ) : currentRole === "securite" ? (
      ...
      />
          <Route path="/recap" element={<Home userDistrict={currentUserConnected?.district} curuser={currentUserConnected} userRole={currentRole} userAutonum={currentUserConnected?.autonum} />} />
        <Route path="/par-cause-admin" element={<HomeCauseAdmin currentUserDistrict={currentUserConnected?.district} currentUserAuto={currentUserConnected?.autonum}/>} />
        <Route path="/par-cause-superadmin" element={<HomeCauseSuperAdmin currentUserDistrict={currentUserConnected?.district} currentUserAuto={currentUserConnected?.autonum}/>} />
        <Route path="/all-accidents-superadmin" element={<AllHome currentUserDistrict={currentUserConnected?.district} currentUserAuto={currentUserConnected?.autonum}/>} />
