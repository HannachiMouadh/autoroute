...
import ShowForm from "../Forms/ShowDataForm";
import { MdDeleteOutline } from "react-icons/md";
import '@fortawesome/fontawesome-free/css/all.min.css';
import PhotoPreview from "../Forms/PhotoPreview";
...
const filteredData = (data, start, end) => {
  ...
  const sumDays = sortedDataArray.length;
            ...
            <Table className="mobile-table">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell className="rtl-text">PK</TableCell>
                ...
                {startDate && endDate && sortedDataArray.length === 0 ? (
                  ...
                  sortedDataArray.map((row) => (
                    <TableRow key={row._id}>
                      ...
                      >
                        {Array.isArray(row.image) && row.image.map((imgPath, index) => {
                          return (
                            <img
                              key={index}
                              src={imgPath}
