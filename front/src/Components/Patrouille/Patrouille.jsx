            ...
            filteredDataArrayPatrouille.map((p, i) => {
              ...
              return (
                ...
                >
                  ...
                  <p>
                    <strong>Heure:</strong> {dateObj.toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit', hour12: false })}
                  </p>
                  <p>
                ...
                filteredDataArrayPatrouille.map((p) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td>{dateObj.toLocaleTimeString('fr-FR', { hour: '2-digit', minute: '2-digit', hour12: false })}</td>
                      <td>{p.matricule}</td>
